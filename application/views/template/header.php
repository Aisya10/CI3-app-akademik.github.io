...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?= base_url('assets/') ?>/images/icon/himasi.jpg">
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="<?= base_url('assets/') ?>/images/icon/himasi.jpg" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="<?= base_url('siswa') ?>" aria-expanded="true"><i class="fa fa-child"></i><span>Siswa
                                    </span></a>
                                <!-- <ul class="collapse">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Aisya Zain<i class="fa fa-angle-down"></i></h4>
